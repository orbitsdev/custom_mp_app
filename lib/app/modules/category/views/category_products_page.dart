...
///
/// Shows all products in a specific category with:
...
class _CategoryProductsPageState extends State<CategoryProductsPage> {
  ...
  void initState() {
    ...
    // Listen to search query changes from controller
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: Obx(() {
          // Show back arrow normally, X when searching
        ...
        title: Obx(() {
          ...
          if (isSearchMode.value) {
            return TextField(
              ...
              decoration: InputDecoration(
                hintText: 'Search in ${controller.category.name}...',
          ...
          // Show category name when not searching
          return Column(
        ...
        actions: [
          Obx(() {
            // Hide actions when in search mode
            if (isSearchMode.value) {
            ...
            return Row(
              ...
              children: [
                // Search button
                IconButton(
                  icon: HeroIcon(HeroIcons.magnifyingGlass, color: Colors.white),
                  onPressed: () {
                    // Enter search mode
        ...
        child: Obx(() {
          ...
          return CustomScrollView(
            ...
            slivers: [
              ...
              // Products masonry grid (dynamic heights)
              SliverPadding(
  ...
  /// Single loading card with shimmer animation
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ShimmerWidget(height: 14, width: double.infinity),
                Gap(8),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              controller.searchQuery.value.isEmpty
                  ? 'Products will appear here once added to ${controller.category.name}'
